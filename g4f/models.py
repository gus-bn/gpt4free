...
class Model:
    ...
    class gpt_35_turbo:
        ...
        best_provider: Providers.Forefront

    class gpt_4:
        name: str = 'gpt-4'
        base_provider: str = 'openai'
        best_provider: Providers.Bing
        best_providers: list = [Providers.Bing, Providers.Lockchat]

    class claude_instant_v1_100k:
        name: str = 'claude-instant-v1-100k'
        base_provider: str = 'anthropic'
        best_provider: Providers.Vercel
    ...
    class gpt_35_turbo_16k:
        ...
        base_provider: str = 'openai'
        best_provider: Providers.EasyChat
